...
public class GameOfLife extends JFrame {
    ...
    private final String NAME_OF_GAME = "Game of Life";
    private final int WINDOW_LOCATION = 100;
    private final int POINT_RADIUS = 10;
    private final int GAME_SIZE = input();
    private final int WINDOW_SIZE = GAME_SIZE * POINT_RADIUS + 8;
    private final int BTN_PANEL_HEIGHT = 60;
    private int timeSleep = 1;
    ...
    private boolean[][] oldGeneration = new boolean[GAME_SIZE][GAME_SIZE];
    private boolean[][] newGeneration = new boolean[GAME_SIZE][GAME_SIZE];
